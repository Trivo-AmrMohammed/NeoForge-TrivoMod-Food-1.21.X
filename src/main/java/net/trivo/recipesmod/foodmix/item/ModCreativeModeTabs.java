...
import net.trivo.recipesmod.foodmix.TrivoRecipesMod;

import java.util.function.Supplier;

public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, TrivoRecipesMod.MODID);

    public static final Supplier<CreativeModeTab> TRIVORECIPES = CREATIVE_MODE_TABS.register("trivo_recipes_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.FRIEDEGG.get()))
                    .title(Component.translatable("creativetab.trivo_recipes_tab"))
